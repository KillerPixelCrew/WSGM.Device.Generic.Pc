...
$source = Join-Path $root "src\WSGM.Device.Generic.Pc"
$project = Join-Path $source "WSGM.Device.Generic.Pc.csproj"
...
$workMarkerValue = "generic-pc-package-work-v1"
$restoreArguments = @()
if ($NoRestore) {
...
$archiveMarkerValue = "generic-pc-package-output-v1|$packageId|$packageVersion"
